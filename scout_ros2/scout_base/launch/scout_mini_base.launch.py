...
def generate_launch_description():
    ...
    scout_base_node = launch_ros.actions.Node(
        ...
        parameters=[{
            ...
            'odom_frame': [LaunchConfiguration('namespace'), '/', LaunchConfiguration('odom_frame')],
            'base_frame': [LaunchConfiguration('namespace'), '/', LaunchConfiguration('base_frame')],
        ...
        remappings=[
            ...
            ('/odom', 'odom'),
            # Removed ('/tf', 'tf') to keep default /tf behavior
        ]
    )
